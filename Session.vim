...
set pyxversion=3
set ruler
set runtimepath=~/.vim,~/.vim/plugged/coc.nvim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=4
set smartindent
set smarttab
set softtabstop=4
...
silent only
silent tabonly
cd ~/pCloudDrive/Egyetem\ jegyzetek/Gyakorlat/3.\ félév/Prog2/Beadandó
...
silent! normal! zE
let &fdl = &fdl
let s:l = 45 - ((21 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 45
let s:c = 79 - ((38 * winwidth(0) + 86) / 172)
if s:c > 0
...
silent! normal! zE
let &fdl = &fdl
let s:l = 41 - ((7 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 41
...
badd +0 Main.java
badd +32 Html.java
badd +36 HtmlIndex.java
badd +16 HtmlImage.java
badd +8 HtmlBuilder.java
badd +1 HtmlBuilder
